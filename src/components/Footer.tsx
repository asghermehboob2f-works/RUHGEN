...
import type { SocialLinkItem, SiteContent } from "@/backend/site-content/types";
...
export function getSocialIcon(platform: string) {
  ...
  if (p.includes("discord")) {
    return <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.061 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.893.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.028zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z" />;
  }
  if (p.includes("telegram")) {
    return <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69.01-.03.01-.14-.07-.2-.08-.06-.19-.04-.27-.02-.12.02-1.96 1.25-5.54 3.69-.52.36-1 .54-1.42.53-.47-.01-1.37-.26-2.03-.48-.82-.27-1.47-.42-1.42-.88.03-.24.37-.49 1.02-.75 4.02-1.75 6.7-2.9 8.04-3.46 3.82-1.6 4.62-1.88 5.14-1.89.11 0 .37.03.54.17.14.12.18.28.2.45-.01.07.01.23 0 .38z" />;
  }
  if (p.includes("tiktok")) {
    return <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 3 15.68 6.34 6.34 0 0 0 9.33 22a6.34 6.34 0 0 0 6.34-6.34V9.26a8.18 8.18 0 0 0 4.77 1.52V7.33a4.85 4.85 0 0 1-.85-.64z" />;
  }
  if (p.includes("reddit")) {
    return <path d="M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 0 1-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.632 4.674 1.488.308-.309.73-.491 1.207-.491.968 0 1.754.786 1.754 1.754 0 .716-.435 1.333-1.056 1.6-.015.165-.024.332-.024.5 0 2.56-2.955 4.64-6.6 4.64-3.645 0-6.6-2.08-6.6-4.64 0-.168-.009-.335-.024-.5A1.75 1.75 0 0 1 3.567 12c0-.968.786-1.754 1.754-1.754.477 0 .899.182 1.207.491 1.194-.856 2.85-1.418 4.674-1.488l.942-4.41 3.253.684a1.248 1.248 0 0 1 .613-.779zM9.544 14.862c-.528 0-.957.429-.957.957 0 .528.429.957.957.957.528 0 .957-.429.957-.957 0-.528-.429-.957-.957-.957zm4.912 0c-.528 0-.957.429-.957.957 0 .528.429.957.957.957.528 0 .957-.429.957-.957 0-.528-.429-.957-.957-.957z" />;
  }
  if (p.includes("whatsapp")) {
    return <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981zm11.387-5.464c-.301-.15-1.785-.881-2.062-.982-.276-.1-.477-.15-.678.15-.2.3-.778.982-.954 1.182-.175.2-.351.225-.652.075-.301-.15-1.272-.469-2.423-1.496-.897-.8-1.502-1.787-1.677-2.087-.175-.3-.019-.462.131-.611.136-.134.301-.35.451-.525.15-.175.201-.3.301-.5.1-.2.05-.375-.025-.525-.075-.15-.678-1.635-.929-2.235-.244-.585-.493-.506-.678-.515-.175-.008-.375-.01-.576-.01s-.527.075-.803.375c-.276.3-1.054 1.032-1.054 2.516s1.079 2.914 1.23 3.114c.15.2 2.123 3.242 5.144 4.546.718.31 1.279.496 1.716.635.721.23 1.377.197 1.896.12.578-.086 1.785-.73 2.036-1.432.251-.702.251-1.303.175-1.432-.075-.129-.276-.204-.577-.354z" />;
  }
  if (p.includes("threads")) {
    return <path d="M12.186 24.004c-3.13 0-5.805-1.127-7.61-3.26-1.742-2.057-2.417-4.9-1.905-8.006.59-3.578 3.106-6.495 6.438-7.464a13.3 13.3 0 0 1 3.738-.507c2.973 0 5.6.932 7.42 2.624 1.636 1.52 2.457 3.568 2.375 5.92-.093 2.668-1.28 4.773-3.34 5.928-1.332.747-2.894 1.134-4.646 1.152h-.097c-1.379 0-2.613-.314-3.473-.884-.716-.475-1.162-1.144-1.29-1.936a.358.358 0 0 1 .324-.413.364.364 0 0 1 .411.32c.098.6.437 1.109.98 1.47.712.472 1.758.736 2.946.736.074 0 .15-.001.228-.002 1.46-.015 2.748-.344 3.829-.95 1.713-.96 2.697-2.71 2.772-4.927.067-1.956-.606-3.64-1.95-4.885-1.572-1.46-3.896-2.268-6.545-2.268a12.56 12.56 0 0 0-3.535.48C7.94 8.163 5.706 10.73 5.187 13.877c-.446 2.71.137 5.176 1.642 6.947 1.547 1.824 3.86 2.793 6.512 2.793 2.756 0 5.234-1.077 6.98-3.033a.36.36 0 0 1 .508-.035.358.358 0 0 1 .035.508c-1.92 2.15-4.646 3.332-7.678 3.332z" />;
  }
  // Default globe / link icon path
...
export function Footer() {
  ...
  const [socialLinks, setSocialLinks] = useState<SocialLinkItem[]>(
    (PUBLIC_DEFAULT_SITE_CONTENT.socialLinks || []).filter((s) => s.enabled !== false)
  );
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!ok || !data.socialLinks) return;
        setSocialLinks(data.socialLinks.filter((s) => s.enabled !== false));
      } catch {
