...
const DEFAULT_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "RUHGEN Premium Video Access (15–30 cr)",
      "Standard Image Generation Access (2-3 cr)",
      "Up to 6 Cinematic Video Clips",
  ...
  },
  {
    ...
    features: [
      ...
      "Seedance 2.5 Flagship Access (30–60 cr)",
      "RUHGEN Premium Video Access (15–30 cr)",
      "Multimodal Reference Guidance",
      "5s, 10s & Extended Clip Lengths",
  ...
  },
  {
    ...
    features: [
      ...
      "Full Seedance 2.5 & RUHGEN Video Engines",
      "Virtual Camera & Motion Controls",
      "Up to 30s Extended Video Generation",
      "Multi-Image & Video Reference Guidance",
...
const CREDIT_RATES = [
  ...
  },
  {
    ...
    model: "Genesis 2 Video Engine",
    cost: "15–30 credits / clip",
    description: "High-fidelity cinematic text-to-video and image-to-video generation.",
    icon: Sparkles,
    color: "#FF2E9A",
  },
  {
    action: "Seedance 2.5 Video",
    model: "Seedance 2.5 Flagship Engine",
    cost: "30–180 credits / clip",
    description: "Flagship video generation with native synchronized audio, multi-reference inputs, and up to 30s duration.",
    icon: Shield,
    color: "#F59E0B",
  },
];
