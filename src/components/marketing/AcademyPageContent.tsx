          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              <div className="text-center">
                <div className="text-xl font-extrabold text-foreground sm:text-2xl">{new Set(tutorials.map(t => t.category)).size} Modules</div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
            ...
            <div className="relative w-full md:w-80 shrink-0">
              ...
              <input
                ...
                className="w-full rounded-full border bg-card/50 py-2.5 pl-10 pr-4 text-sm text-foreground placeholder-muted-foreground/30 transition-all focus:border-[#7B61FF] focus:outline-none focus:ring-1 focus:ring-[#7B61FF]/50"
        ...
        {activeVideo && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-5xl overflow-hidden rounded-3xl border bg-card/90 shadow-2xl backdrop-blur-2xl flex flex-col md:flex-row"
            ...
            >
              ...
              <div className="relative w-full md:w-[65%] bg-black flex-shrink-0 flex items-center justify-center min-h-[300px]">
                <video
              ...
              {(() => {
                ...
                return (
                  <div className="flex flex-col p-6 md:p-8 w-full border-t md:border-t-0 md:border-l bg-card/45" style={{ borderColor: "var(--border-subtle)" }}>
